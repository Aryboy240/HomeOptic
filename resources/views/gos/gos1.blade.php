...
function saveEgosForm() {
    ...
    fetch('{{ route('egos.store') }}', {
        ...
        body: JSON.stringify({ patient_id: {{ $patient->id }}, form_type: 'GOS1', form_data: fields, voucher_value: {{ $existingSubmission?->voucher_value ?? 'null' }} })
    }).then(function(r) {
        if (r.ok) {
...
document.addEventListener('DOMContentLoaded', function() {
    initSignaturePad('sig-gos1-patient-part2',    'sig-gos1-patient-part2-data');
    initSignaturePad('sig-gos1-performer-part3',  'sig-gos1-performer-part3-data');
    initSignaturePad('sig-gos1-contractor-part3', 'sig-gos1-contractor-part3-data');
...
<div class="section">
    ...
    <div class="g2">
        <div>
            ...
            <canvas id="sig-gos1-patient-part2" width="400" height="80" style="display:block; width:100%; max-width:400px; height:80px; border:1px solid #000; background:#fff; cursor:crosshair; margin-top:4px;"></canvas>
            <input type="hidden" id="sig-gos1-patient-part2-data" name="sig-gos1-patient-part2">
            <button type="button" class="no-print" onclick="clearSig('sig-gos1-patient-part2')" style="font-size:7pt; color:#555; background:none; border:1px solid #bbb; border-radius:2px; padding:1px 6px; cursor:pointer; margin-top:2px;">Clear</button>
...
<div class="pb pb-visual">
    ...
    <div class="section">
        ...
        <div class="fl" style="margin-top:3px; align-items:flex-start;">
            ...
            <div>
                <canvas id="sig-gos1-performer-part3" width="300" height="70" style="display:block; width:300px; height:70px; border:1px solid #000; background:#fff; cursor:crosshair;"></canvas>
                <input type="hidden" id="sig-gos1-performer-part3-data" name="sig-gos1-performer-part3">
                <button type="button" class="no-print" onclick="clearSig('sig-gos1-performer-part3')" style="font-size:7pt; color:#555; background:none; border:1px solid #bbb; border-radius:2px; padding:1px 6px; cursor:pointer; margin-top:2px;">Clear</button>
                <p class="no-print" style="font-size:7pt; color:#888; margin-top:1px; font-style:italic;">Sign here (use mouse or touch)</p>
            </div>
        </div>
        ...
        <div style="border-top:1pt solid #bbb; padding-top:7px; margin-top:7px;">
            ...
            <div class="g2">
                <div>
                    <p style="font-size:8pt; font-weight:bold; margin-bottom:2px;">Signature</p>
                    <canvas id="sig-gos1-contractor-part3" width="400" height="80" style="display:block; width:100%; max-width:400px; height:80px; border:1px solid #000; background:#fff; cursor:crosshair; margin-top:4px;"></canvas>
                    <input type="hidden" id="sig-gos1-contractor-part3-data" name="sig-gos1-contractor-part3">
                    <button type="button" class="no-print" onclick="clearSig('sig-gos1-contractor-part3')" style="font-size:7pt; color:#555; background:none; border:1px solid #bbb; border-radius:2px; padding:1px 6px; cursor:pointer; margin-top:2px;">Clear</button>
                    <p class="no-print" style="font-size:7pt; color:#888; margin-top:1px; font-style:italic;">Sign here (use mouse or touch)</p>
