...
<div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm p-5 mb-5">
    ...
    <div class="mt-4">
        ...
        <textarea id="notes" name="notes" rows="3"
            class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm">{{ old('notes', $patient?->notes) }}</textarea>
...
{{-- Medical Information --}}
<div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm p-5 mb-5">
    <h3 class="text-sm font-semibold text-gray-800 dark:text-gray-100 uppercase tracking-wide mb-4">Medical Information</h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <textarea id="physical_disabilities" name="physical_disabilities" rows="2"
                class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm">{{ old('physical_disabilities', $patient?->physical_disabilities) }}</textarea>
        ...
        <div>
            ...
            <textarea id="mental_health_conditions" name="mental_health_conditions" rows="2"
                class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 text-sm">{{ old('mental_health_conditions', $patient?->mental_health_conditions) }}</textarea>
...
{{-- Social & Benefits --}}
<div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm p-5 mb-5">
    <h3 class="text-sm font-semibold text-gray-800 dark:text-gray-100 uppercase tracking-wide mb-4">Social &amp; Benefits</h3>
    ...
    <div class="mb-5">
        <p class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Benefits Received</p>
        @php
            ...
            @foreach([
                ...
                <label class="flex items-start gap-2 text-sm text-gray-700 dark:text-gray-300">
                    <input type="checkbox" name="benefits[]" value="{{ $value }}"
                        ...
                        class="mt-0.5 rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 text-indigo-600">
                    <span>{{ $label }}</span>
                </label>
            @endforeach
        </div>
