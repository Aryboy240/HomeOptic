...
class ExaminationController extends Controller
{
    ...
    public function updateRefraction(Request $request, Examination $examination): RedirectResponse
    {
        $validated = $request->validate([
            ...
            'current_r_prism'       => ['nullable', 'string', 'max:20'],
            ...
            'current_l_prism'       => ['nullable', 'string', 'max:20'],
            ...
            'prev_other_r_prism'    => ['nullable', 'string', 'max:20'],
            ...
            'prev_other_l_prism'    => ['nullable', 'string', 'max:20'],
